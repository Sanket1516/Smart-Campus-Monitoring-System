        ...
        <header className="bg-white border-b border-gray-200 px-4 py-3 flex items-center gap-4 md:px-6 dark:bg-slate-900 dark:border-slate-800">
          ...
          <div className="ml-auto flex items-center gap-3">
            ...
            <button
              type="button"
              onClick={handleLogout}
              className="inline-flex items-center gap-2 rounded-lg border border-red-200 bg-red-50 px-3 py-2 text-sm font-medium text-red-700 transition-colors hover:bg-red-100 dark:border-red-700 dark:bg-red-900/20 dark:text-red-400 dark:hover:bg-red-900/30"
              title="Logout"
            >
              <HiOutlineLogout className="w-5 h-5" />
